...
class RNN_classifier(nn.Module):
    def __init__(self,hidden,word_size,layers_size,binary = True):
        ...
        # ussing from pretrained to load the weights of wordembedding 
        self.embedding = nn.Embedding.from_pretrained(text_field.vocab.vectors)
        # we use the glove.6B.200d therefore the output dimension is 200
        self.hidden=200
...
# build vocab using the pretraied glove word embedding, this is included in the torchtext package.
